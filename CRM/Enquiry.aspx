<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Enquiry.aspx.cs" Inherits="CRM.Enquiry" %>
                            ...
                            <div class="card due-dates">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <span>School</span>
                                            <asp:TextBox ID="txtSchool" runat="server" Enabled="false" class="form-control" data-toggle="validator"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                            </div>
